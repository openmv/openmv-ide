...
def make():
    ...
    if args.rpi:
        ...
        with open(os.path.join(installdir, "setup.sh"), 'w') as f:
            f.write("#! /bin/sh\n\n")
            f.write("sudo apt-get install -y libpng* libxcb* libGLES* libts* libsqlite* libodbc* libsybdb* libusb-1.0 python-pip libgles2-mesa-dev libpng-dev libpng12-dev qt5-default libts-dev\n")
            ...
            f.write("    read -r -p \"Install Desktop Shortcut? [y/n] \" _response\n")
            ...
            f.write("Exec=/home/$USER/openmvide/bin/openmvide.sh\n")
            f.write("Icon=/home/$USER/openmvide/openmv.png\n")
